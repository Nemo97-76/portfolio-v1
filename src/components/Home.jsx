    ...
    <div className="App" data-theme={isDark ? "dark" : "light"}>
      ...
      <div className="home" id="home">
        <h2 className="InteroHeading">
          ...
          <br />
          <Typer />
          <span className="welcomeMessage">From Alexandria, Egypt</span>
        </h2>
        <div className="NavToResume">
          <Nav.Link href="#Resume">
            <Button className="ResumeButton mt-5">Resume</Button>
          </Nav.Link>
          <br></br>
          <Nav.Link href="#Resume">
            <ArrowDownwardRoundedIcon className="Arrow" />
          </Nav.Link>
        </div>
        <BackToTop />
      </div>
        ...
        >
          <div className="content" style={{ width: "45%" }}>
            <span id="title" className="BioHeading">
              Hi,I'm <b className="self">Tasneem Youssef</b>
            </span>
            <br></br>
            <span className="Bio">
      ...
      <div id="Resume" className="Resume ">
        <p className="mb-4 ResumeTitle">Resume</p>
        <h3
          className="BioHeading mb-4"
          data-aos="fade-up"
          data-aos-delay="300"
          data-aos-duration="15000"
        >
          ...
          >
            ...
            <div className="detailsBox">
              <div>
                ...
                <span className="eductiondetails">
                  from 2018 to 2022 i majored in physics ,minor in chemistry as
                  Bechelor student in Alexandria universty, studied some basic
                  programming concepts, and some logic, which helped me in my
                  journey to study web developer after graduation.
                </span>
              </div>
            </div>
            ...
            <div className="detailsBox">
              <div>
                <h5>HTML/CSS</h5>
                <span className="eductiondetails">
                  the basic where i started learing web development, i have a
                  good experience in it, and i can create responsive websites
                  using it.
                </span>
              </div>
            </div>
          ...
          >
            <div className="detailsBox">
              <div>
                <h5>bootstrap</h5>
                <span className="eductiondetails">
                  the most popular css framework, i have a good experience in
                  it, and i can create responsive websites using it, i can also
                  use MUI libary , awsome fonts and google fonts to make my
                  websites more attractive and user friendly, that's what i
                  usally use to make my websites more attractive and user
                  friendly.
                </span>
              </div>
        ...
        <div className="btnHolder mt-5 pb-5">
          <DownloadButton
            fileurl={resume}
            filename="tasneem-Youssef-Resume.pdf"
          />
        </div>
      </div>
      <div className="portfolio">
        <p id="portfolio" className="mt-4">
          portfolio
        </p>
        <h3
          className="mt-4"
      ...
      <div className="Hire mb-5">
        <div>
          ...
          >
            Interested in working with me?<br></br>
          </h2>
          <Button
            data-aos="fade-left"
            data-aos-delay="1500"
        ...
        <div className="rightform ">
          <form id="Form">
            <div data-aos="fade-up">
              <label className="mt-5">what's your Name</label>
              <br></br>
              <input type="text" required className="nameInput" />
            </div>

            <div data-aos="fade-up" data-aos-delay="750">
              <label className="mt-4">your email address</label>
              <br></br>
              <input type="email" required className="nameInput" />
            </div>
            <div data-aos="fade-up" data-aos-delay="800">
              <label className="mt-4">how can i help you</label>
              <br></br>
            ...
            >
              {<BsExclamationLg size={30} color="#e57734" />}project details has
              been sent ,i'll text you back soon <br></br>
      ...
      <div className="footer text-center ">
        <p>
          ...
          <span className="text">Tasneem Youssef</span>. All rights reserved.
        </p>
      </div>
    </div>
  );
