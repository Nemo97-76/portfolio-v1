    ...
    <div id="clientSpeak">
      ...
      >
          ...
          <div>
            <div className="speakContainer">
              <div className="clientcomment">
                ...
                industry quidam interesset his et.
              </div>
            </div>

            <Avatar src={client1} className="review1 Avatar mt-3 "></Avatar>
            <p className="pt-3">
              chris Tom <p className="clientDetails">user from UK</p>
            </p>
          </div>
        </Carousel.Item>
        {/* item1 */}
        ...
        <Carousel.Item className="CarosuelItem">
          ...
          <p className="pt-3">
            dennis jacques <p className="clientDetails">noon inc</p>
          </p>
        </Carousel.Item>
        {/* item2 */}
        ...
        <Carousel.Item className="CarosuelItem">
          ...
          <p className="pt-3">
            Patrick Cary<p className="clientDetails">freelancer from USA</p>
          </p>
        </Carousel.Item>
        {/* item3 */}
      </Carousel>
